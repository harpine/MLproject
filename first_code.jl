using Pkg
Pkg.activate(pwd())
using Plots, StatsPlots, DataFrames, Random, CSV, MLJ, MLJLinearModels, NearestNeighborModels, CategoricalDistributions, CategoricalArrays, MLJLIBSVMInterface, MLJFlux, Flux#, MLJDecisionTreeInterface
